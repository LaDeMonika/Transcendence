...
//TO-DO - ADD: “Description” section should also contain a clear name for the project and its key features.
...
### Resources
//TO-DO - ADD: section listing classic references related to the topic (documen-tation, articles, tutorials, etc.), as well as a description of how AI was used — specifying for which tasks and which parts of the project
...
| DEV (full-stack) | [Monika Simic (msimic)](https://profile.intra.42.fr/users/msimic), tbd | Delivers end-to-end features across frontend/backend, stitches APIs and UI, ensures integration quality. |
